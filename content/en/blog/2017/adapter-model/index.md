...
## Handlers: configuring adapters{#handlers-configuring-adapters}
...
## Templates: adapter input schema{#templates-adapter-input-schema}
...
## Instances: attribute mapping{#instances-attribute-mapping}
...
## Rules: delivering data to adapters{#rules-delivering-data-to-adapters}
