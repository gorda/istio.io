...
## Don’t optimize layers, remove them{#don’t-optimize-layers-remove-them}
...
## Delayering the stack{#Delayering-the-stack}
...
### Network devirtualization{#network-devirtualization}
...
### Artifacts of container networking{#artifacts-of-container-networking}
...
### Skip TCP/IP for colocated endpoints{#skip-TCP-IP-for-colocated-endpoints}
...
### Data pushing proxy{#data-pushing-proxy}
...
### Proxyless protocol decoding{#Proxyless-protocol-decoding}
...
### Zero-cost load balancer, firewall and network analyzer{#zero-cost-load-balancer-firewall-and-network-analyzer}
...
#### Socket delegation{#socket-delegation}
...
#### "Sidecar-aware" applications{#sidecar-aware-applications}
...
## How does it all come together?{#how-does-it-all-come-together}
...
### AppSwitch client injection{#AppSwitch-client-injection}
...
### Agent for policy acquisition{#agent-for-policy-acquisition}
...
### Platform adapter for AppSwitch "Auto-Curated" service registry{#platform-adapter-for-AppSwitch-auto-curated-service-registry}
...
### Proxy integration and chaining{#proxy-integration-and-chaining}
...
## It's not just about performance{#it's-not-just-about-performance}
...
### Automatic application onboarding and policy authoring{#automatic-application-onboarding-and-policy-authoring}
...
### Broader application and protocol support{#broader-application-and-protocol-support}
...
### Client IP preservation and end-to-end principle{#client-IP-and-end-to-end-principle}
...
### Enhanced application signal with access to encrypted headers{#enhanced-application-signal-with-access-to-encrypted-headers}
...
## So what’s the net?{#so-what’s-the-net}
